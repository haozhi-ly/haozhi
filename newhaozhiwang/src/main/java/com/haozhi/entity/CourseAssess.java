...
public class CourseAssess {
	...
	public CourseAssess(int csid, int userid, int cmid, String content,
			String time, int readstatus, String temp01, String temp02,
			String temp03) {
		super();
		this.csid = csid;
		this.userid = userid;
	...
	public String toString() {
		return "CourseAssess [csid=" + csid + ", userid=" + userid + ", cmid="
				+ cmid + ", content=" + content + ", time=" + time
				+ ", readstatus=" + readstatus + ", temp01=" + temp01
