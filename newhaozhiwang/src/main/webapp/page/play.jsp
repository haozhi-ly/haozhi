	...
	<ul class="fixed-bar">
      ...
      APP
		...
		<li class="hz-feedback">
			...
			<a href="http://www.howzhi.com/feedback/user/list?feedurl=http://www.howzhi.com/course/2155/lesson/33117" target="_blank" class="js-feedback fixed-bar-text">
      问题反馈
    </a>
		</li>
		<li class="go-top" style="display: list-item;">
			<a class="fixed-bar-icon" href="javascript:;">
