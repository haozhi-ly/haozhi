	...
	<div class="learn-dashboard toolbarhide" id="lesson-dashboard"
		...
		<div class="dashboard-content">
			<div class="dashboard-body" id="dashboard-body">
				...
				<div id="learn-loading" class="learn-load text-center"
					style="display: none;">正在加载请稍候...</div>
				<div class="lesson-content" id="lesson-video-content"
					data-role="lesson-content" style="display: none;"
					data-watermark="http://f1.howzhi.com/system/watermark_1438736692.png"
					data-user-id="2358982" data-balloon-player="1"></div>
				<div class="watermarkEmbedded">
					<input type="hidden" id="videoWatermarkEmbedded" value="0">
				</div>
				<div class="lesson-content lesson-content-audio"
					id="lesson-audio-content" data-role="lesson-content"
					style="display: none;"></div>
				<div class="lesson-content" id="lesson-swf-content"
					data-role="lesson-content"
					style="display: none; text-align: center">
					<h1 style="color: #fff; margin-top: 200px;">抱歉!该课程还未添加课时内容!!!</h1>
				</div>
				<div class="lesson-content" id="lesson-iframe-content"
					data-role="lesson-content" style="display: none;">
					<iframe scrolling="no"
						style="position: absolute; left: 0; top: 0; height: 100%; width: 100%; border: 0px;"
						src="http://player.youku.com/embed/XNDY2NTYwMjI4">
						<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
						<html>
<head>
<body>
	<div id="youku-playerBox" style="width: 100%; height: 100%;">
		<object id="youku-player" width="100%" height="100%" data=""
			type="application/x-shockwave-flash">
	</div>
	<script id="_youkujs_" type="text/javascript"
		src="http://player.youku.com/jsapi"></script>
</body>
						</html>
					</iframe>
				</div>
				<div class="lesson-content lesson-content-text"
					id="lesson-text-content" style="display: none;">
					<div class="lesson-content-text-body" id="lesson-text"
						onmousewheel="return scroll(event,this)"
						style="overflow-y: auto; overflow-x: auto; width: 880px; height: 500px;">
					</div>
				</div>

				<div class="lesson-content lesson-content-document"
					id="lesson-document-content" data-role="lesson-content"
					style="display: none;">
					<div class="lesson-content-document-body"></div>
				</div>

				<div class="lesson-content lesson-content-text"
					id="lesson-live-content" data-role="lesson-content"
					style="display: none;">
					<div class="lesson-content-text-body"></div>
				</div>
				<div class="lesson-content lesson-content-text"
					id="lesson-unpublished-content" data-role="lesson-content"
					style="display: none;">
					<div class="lesson-content-text-body">当前课时正在编辑中，暂时无法观看。</div>
				</div>

				<div class="lesson-content lesson-content-text"
					id="lesson-testpaper-content" data-role="lesson-content"
					style="display: none;">
					<div class="lesson-content-text-body"></div>
				</div>
				<div class="lesson-content lesson-content-text"
					id="lesson-ppt-content" data-role="lesson-content"
					style="display: none;">
					<div class="lesson-content-text-body"></div>
				</div>
			</div>
				...
				<div id="toolbar-1" class="tab-pane courselist active">
					...
					<ul class="period-list hz-courselist" id="course-item-list">
						...
						<li class="period lesson-item lesson-item-33117  item-active"
							...
							href="http://www.howzhi.com/course/2155/lesson/33117"
							title="Mark Crilley漫画教程:头发的画法"> <i
								class="es-icon es-icon-undone status-icon"></i> <span
								class="title">L1：Mark Crilley漫画教程:头发的画法</span> <!-- 紧跟标题 --> <!-- 右边图标 -->
		...
		<div class="learn-dashboard-foot">
			...
			<div class="right">
				<a data-step="7" data-intro="为了更好地记录自己的学习进度，学完课程记得点击“学过了”按钮哦"
					...
					href="http://www.howzhi.com/course/2155/lesson/33118"
					data-role="next-lesson" data-placement="right" title="下一课时"
					class="course-title t-gray"> 下一课: Sophie-chan漫画教程:黑执事 塞巴斯蒂安 </a>
		...
		<div class="row">
			...
			<aside class="col-md-3 course-sidebar">
				<div class="flat ">
					<h3>课时简介</h3>
					<div class="words">
						<i class="fa fa-flag pull-left"></i>对motion
						v2脚本进行全面介绍，通过一下简单的小案例让你轻松掌握。
					</div>
				</div>
				<div class="flat sidebar-teach media">
					...
					<div class="media-left">
						<a class=" js-user-card" href="javaScript:void(0);"
							...
							class="avatar-sm" id="teachImg" src="images/avatar.png"
							alt="Orchid">
						</a>
					...
					<div class="teach-info media-body">
						<p class="text-o-show">
							<a class="link-light " href="javaScript:void(0);">Orchid</a> <span
