  ...
  <div class="container" >
    ...
    <div class="pull-right user-nav clearfix" id="topf" >
    	<ul class="nav pull-right">
	        ...
	        <li class="dropdown user-nav-dropdown user-img"> <a href="#" class="dropdown-toggle" id="toggle"> <img src="${users.photo }" class="user-avatar" alt="${users.uname }" id="${users.userid}"> </a>
          		<ul class="dropdown-menu" role="menu" id="dropdown-menu">
