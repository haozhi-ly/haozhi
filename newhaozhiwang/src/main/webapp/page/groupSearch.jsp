			            		...
			            		<c:forEach items="${searchgroups}" var="item">
			            			<div class="col-md-3" >
										<div class="media group-media group-media-sm">
											<a href="groups/showsearch?groupname=${item.groupname }" title="${item.groupname }" class="pull-left">
												<img src="images/105050a0ca1c653470.jpg" alt="${item.groupname }" class="media-object">
											</a>
											<div class="media-body">
												<p>
													<a href="groups/showsearch?groupname=${item.groupname }" title="${item.groupname }">${item.groupname }</a>
												</p>
